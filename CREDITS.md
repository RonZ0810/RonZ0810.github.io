...
- [Shrub 01](https://polyhaven.com/a/shrub_01), Rico Cilliers — optimized glTF, 1K textures, shared across the garden. Trees, hedges, path, hallway, and enclosed architecture are original procedural geometry.
